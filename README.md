# Ministry Centered Technologies - December 2013
...
made pending with the `skip` declaration.

Once you get the first test passing, delete the `skip` from the
next step.

Continue until all the tests are passing.
